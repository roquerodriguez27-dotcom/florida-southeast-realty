...
const BENEFITS = [
  ...
  },
  {
    ...
    body: "The brokerage is being built around organized CRM workflows, saved-search activity, and AI-assisted follow-up so good opportunities are less likely to slip away.",
  },
  {
    number: "05",
  ...
  },
  {
    ...
    body: "Know what is needed, when it is due, and who to call. Complete files are handled through a straightforward process designed for prompt commission processing.",
  },
  {
    number: "07",
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "No. Florida Southeast Realty is investing in its website, advertising, and follow-up systems, and company-generated opportunities may be routed to participating agents. No specific number, quality, or closing rate is promised.",
  },
  {
    ...
    <div className="pb-24">
        ...
        <div className="container-fsre relative">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-sand/80 md:text-xl">
              A tech-forward, independent South Florida brokerage for agents who
              want clear economics, direct broker support, and fewer layers
              between a good opportunity and a closed transaction.
            </p>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <a
                href="#apply"
                className="rounded-sm bg-hibiscus px-6 py-3.5 text-center text-sm font-medium text-sand transition-colors hover:bg-hibiscus-dark"
              >
                Start a Confidential Conversation
              </a>
              <Link
                href="/contact"
                className="rounded-sm border border-sand/30 px-6 py-3.5 text-center text-sm font-medium text-sand transition-colors hover:border-sand/60 hover:bg-white/5"
              >
                Contact the Broker
              </Link>
            </div>
            <p className="mt-4 max-w-2xl text-xs leading-relaxed text-sand/50">
              No pressure and no obligation. Commission plans, fees, technology
              availability, and onboarding requirements are reviewed before you
              join.
            </p>
          </div>
        </div>
      ...
      <section className="border-b border-ink/10 bg-white">
        <div className="container-fsre grid gap-px bg-ink/10 sm:grid-cols-3">
          <div className="bg-white px-6 py-7 text-center">
            <p className="font-display text-2xl text-tide">100%</p>
            <p className="mt-1 text-xs uppercase tracking-wide text-ink/55">
              Commission options available
            </p>
          </div>
          <div className="bg-white px-6 py-7 text-center">
            <p className="font-display text-2xl text-tide">Direct</p>
            <p className="mt-1 text-xs uppercase tracking-wide text-ink/55">
              Broker access
            </p>
          </div>
          <div className="bg-white px-6 py-7 text-center">
            <p className="font-display text-2xl text-tide">Modern</p>
            <p className="mt-1 text-xs uppercase tracking-wide text-ink/55">
      ...
      <section className="container-fsre py-20 md:py-24">
        <div className="max-w-2xl">
          <p className="mb-2 font-mono text-xs uppercase tracking-[0.2em] text-hibiscus">
            Why Florida Southeast Realty
          </p>
          <h2 className="font-display text-3xl leading-tight text-ink md:text-4xl">
            The support you need. The independence you want.
          </h2>
          <p className="mt-4 leading-relaxed text-ink/65">
            We are building the brokerage around agent productivity—not layers
            of management, vague fees, or technology that creates more work than
            it removes.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-px overflow-hidden rounded-sm border border-ink/10 bg-ink/10 md:grid-cols-2">
          {BENEFITS.map((benefit) => (
            <article key={benefit.number} className="bg-sand p-6 md:p-8">
              ...
              <h3 className="mt-3 font-display text-xl text-tide">
                {benefit.title}
              </h3>
      ...
      <section className="bg-keystone py-20 md:py-24">
        <div className="container-fsre grid items-start gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h2 className="font-display text-3xl leading-tight text-ink md:text-4xl">
              Less busywork. More consistent follow-up.
            </h2>
            <p className="mt-5 leading-relaxed text-ink/70">
              The goal is not another stack of apps. It is a connected path from
              the first inquiry to the next conversation, property alert,
              appointment, and closing.
            </p>
            <div className="mt-6 border-l-2 border-brass pl-4 text-sm leading-relaxed text-ink/60">
              Some CRM, automation, IDX, and agent-dashboard capabilities are
              still being rolled out. We will tell you what is live today, what
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              [
                "Lead capture",
                "Website and advertising inquiries organized for timely response.",
              ],
              [
                "CRM visibility",
                "Contacts, notes, saved searches, and follow-up tasks in one workflow.",
              ],
              [
                "AI assistance",
                "Draft outreach and reminders that support—not replace—your judgment.",
              ],
              [
                "Agent insights",
                "A growing dashboard for client activity and business priorities.",
              ],
            ].map(([title, body]) => (
              <div
                key={title}
      ...
      <section className="container-fsre py-20 md:py-24">
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-3">
          {STEPS.map((step) => (
            <div
              key={step.number}
              className="relative border-t border-brass pt-6"
            >
              <span className="font-mono text-sm text-hibiscus">
        ...
        <div className="container-fsre grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-4 max-w-md leading-relaxed text-sand/65">
              A brokerage change is a business decision. You deserve direct
              answers about the money, support, technology, and expectations.
            </p>
          </div>
            ...
            {FAQS.map((faq) => (
              <details key={faq.question} className="group py-5">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-4 font-medium text-sand">
                  ...
                  <span
                    aria-hidden="true"
                    className="text-xl font-light text-brass transition-transform group-open:rotate-45"
                  >
                    +
                  </span>
                </summary>
                <p className="max-w-2xl pt-3 text-sm leading-relaxed text-sand/65">
                  {faq.answer}
                </p>
              </details>
            ))}
      ...
      <section id="apply" className="scroll-mt-24 bg-white py-20 md:py-24">
        <div className="container-fsre grid items-start gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="lg:sticky lg:top-28">
            ...
            <p className="mt-5 leading-relaxed text-ink/70">
              Share enough for us to understand your goals. If there is a
              potential fit, Roque will follow up for a private conversation.
            </p>
            <div className="mt-8 rounded-sm border border-brass/30 bg-brass/10 p-5">
              <p className="font-medium text-tide">
                Your current brokerage will not be contacted.
              </p>
              <p className="mt-2 text-sm leading-relaxed text-ink/60">
                Submitting this form does not create an employment,
                independent-contractor, or brokerage relationship and does not
                guarantee affiliation, leads, production, or income.
              </p>
            </div>
          </div>
            ...
            fields={[
              ...
              { name: "phone", label: "Phone", type: "tel", required: true },
              {
                ...
                options: [
                  ...
                  {
                    value: "inactive-florida",
                    label: "Inactive Florida license",
                  },
              ...
              },
              {
                ...
                colSpan: 2,
                placeholder:
                  "Tell us what would help you grow and what is missing today.",
              },
            ]}
          />
        </div>
